...
2. **Edit `frontend/.env.production.local`** with your production values:
   ...
   REACT_APP_BASE_URL=https://rent-manager-fe.s3-website.fr-par.scw.cloud
   ...
   REACT_APP_REDIRECT_URI=https://rent-manager-fe.s3-website.fr-par.scw.cloud/auth/callback
...
**Frontend URL**: `https://rent-manager-fe.s3-website.fr-par.scw.cloud`
...
3. **Edit `backend/.env.production.local`** with your production values:
   ...
   FrontendUrl=https://rent-manager-fe.s3-website.fr-par.scw.cloud
   UsePostgres=true
...
| `REACT_APP_BASE_URL` | Frontend base URL | `https://rent-manager-fe.s3-website.fr-par.scw.cloud` |
...
| `REACT_APP_REDIRECT_URI` | OAuth redirect URI | `https://rent-manager-fe.s3-website.fr-par.scw.cloud/auth/callback` |
...
| Variable | Description | Example |
|----------|-------------|---------|
| `FrontendUrl` | Frontend URL for CORS | `https://rent-manager-fe.s3-website.fr-par.scw.cloud` |
...
1. **Configure Zitadel redirect URIs**:
   - Add `https://rent-manager-fe.s3-website.fr-par.scw.cloud/auth/callback` to allowed redirect URIs
   - Add `https://rent-manager-fe.s3-website.fr-par.scw.cloud/logout` to post-logout redirect URIs
